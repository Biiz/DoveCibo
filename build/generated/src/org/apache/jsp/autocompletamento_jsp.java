...
public final class autocompletamento_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("            -webkit-box-shadow: 0 5px 10px rgba(0, 0, 0, 0.2);\n");
      out.write("               -moz-box-shadow: 0 5px 10px rgba(0, 0, 0, 0.2);\n");
      out.write("                    box-shadow: 0 5px 10px rgba(0, 0, 0, 0.2);\n");
      out.write("        }\n");
      out.write("        .ui-autocomplete > li {\n");
      out.write("          padding: 3px 20px;\n");
      out.write("        }\n");
      out.write("        .ui-autocomplete > li.ui-state-focus {\n");
 ...
 if (cookies[i].getValue().equals("3")  && session.getAttribute("user_res").equals("no")){
      ...
      out.write("                                <input type=\"text\" name=\"go\" class=\"form-control autocomplete\" placeholder=\"Cerca un ristorante\" required>\n");
